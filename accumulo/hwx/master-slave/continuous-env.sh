...
HADOOP_HOME=${HADOOP_HOME:-/usr/local/lib/hadoop}
HADOOP_PREFIX=${HADOOP_PREFIX:-$HADOOP_HOME}
ACCUMULO_HOME=${ACCUMULO_HOME:-/Users/jelser/projects/accumulo.git/assemble/target/accumulo-1.7.0-SNAPSHOT-dev/accumulo-1.7.0-SNAPSHOT}
ACCUMULO_CONF_DIR=${ACCUMULO_CONF_DIR:-$ACCUMULO_HOME/conf}
JAVA_HOME=${JAVA_HOME:-/Library/Java/JavaVirtualMachines/jdk1.7.0_55.jdk/Contents/Home}
ZOOKEEPER_HOME=${ZOOKEEPER_HOME:-/usr/local/lib/zookeeper}

CONTINUOUS_LOG_DIR=$ACCUMULO_HOME/test/system/continuous/logs
INSTANCE_NAME=accumulorepl1
ZOO_KEEPERS=localhost
